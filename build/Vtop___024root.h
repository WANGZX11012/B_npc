...
class alignas(VL_CACHE_LINE_BYTES) Vtop___024root final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        CData/*0:0*/ top__DOT__u_core__DOT__m_done;
        CData/*0:0*/ top__DOT__u_core__DOT__m_rvalid;
        CData/*0:0*/ top__DOT__u_core__DOT__m_bvalid;
        ...
        CData/*0:0*/ top__DOT__u_core__DOT__mem_we;
        ...
        CData/*0:0*/ top__DOT__u_core__DOT__rtc_arvalid;
    ...
    struct {
        ...
        VL_OUT(pc,31,0);
        VL_OUT(ir_dbg,31,0);
        IData/*31:0*/ top__DOT__u_core__DOT__inst;
        IData/*31:0*/ top__DOT__u_core__DOT__m_req_addr;
        IData/*31:0*/ top__DOT__u_core__DOT__m_req_wdata;
