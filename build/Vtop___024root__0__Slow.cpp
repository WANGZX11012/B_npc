...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT__u_core__DOT__rtc_rresp = VL_SCOPED_RAND_RESET_I(2, __VscopeHash, 11930036895760374022ull);
    vlSelf->top__DOT__u_core__DOT____Vcellinp__u_rtc__arvalid = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 16365777932780731226ull);
    ...
    vlSelf->top__DOT__u_core__DOT__pmem_sel = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 13733275067122597101ull);
    vlSelf->top__DOT__u_core__DOT____Vcellinp__u_mem__awvalid = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 6092680524174250902ull);
    vlSelf->top__DOT__u_core__DOT__mmio_flag = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 10489147620269404093ull);
    vlSelf->top__DOT__u_core__DOT__u_ifu__DOT__handshake_done = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 5925353114667453405ull);
    vlSelf->top__DOT__u_core__DOT__u_ifu__DOT__resp_rdata = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 2180052881195364075ull);
    ...
    vlSelf->top__DOT__u_core__DOT__u_arb__DOT__m_req_addr = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 6430398057125256458ull);
    vlSelf->top__DOT__u_core__DOT__u_arb__DOT__m_req_wdata = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 16326055448461108382ull);
    vlSelf->top__DOT__u_core__DOT__u_arb__DOT__m_done = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 12318895292898334267ull);
    ...
    vlSelf->top__DOT__u_core__DOT__u_master__DOT__rvalid = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 10983075676838397424ull);
    vlSelf->top__DOT__u_core__DOT__u_master__DOT__rready = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 7097394892294312031ull);
    vlSelf->top__DOT__u_core__DOT__u_master__DOT__bvalid = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 5442982831327668478ull);
    vlSelf->top__DOT__u_core__DOT__u_master__DOT__bready = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 5032806448280613461ull);
    ...
    vlSelf->top__DOT__u_core__DOT__u_lfsr__DOT__state = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 7841594278194222986ull);
    ...
    vlSelf->top__DOT__u_core__DOT__u_mem__DOT__busy = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 5816512809425372447ull);
    vlSelf->top__DOT__u_core__DOT__u_idu__DOT__mem_re = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 16771118417031673937ull);
    vlSelf->top__DOT__u_core__DOT__u_idu__DOT__mem_we = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 8087118900108135093ull);
    ...
    vlSelf->top__DOT__u_core__DOT__u_exu__DOT__imm = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 3818817114175992050ull);
    vlSelf->top__DOT__u_core__DOT__u_CSRFile__DOT__csr_wen = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 10379518606721134732ull);
    vlSelf->top__DOT__u_core__DOT__u_CSRFile__DOT__csr_wdata = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 11885866361410323179ull);
    vlSelf->top__DOT__u_core__DOT__u_CSRFile__DOT__csr_data = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 4677587175002221894ull);
